...
- **G1 status: LOCAL IMPLEMENTATION COMPLETE / ARCHITECT REVIEW REQUIRED.** Calibration remains `CALIBRATION_REQUIRED`; V5.5C remains blocked; no next calibration slice is authorized.
