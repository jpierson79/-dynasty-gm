...
- **G2 status: LOCAL IMPLEMENTATION COMPLETE / ARCHITECT REVIEW REQUIRED.** Calibration remains `CALIBRATION_REQUIRED`; no later calibration slice is authorized; V5.5C remains blocked.
