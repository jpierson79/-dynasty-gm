...
const loaded=await loadCanonicalPlayerIntelligenceInput({leagueId,playerId,season:2026,asOfDate,repositories:{players:{allPlayers:async()=>[player]},metrics:{listMetrics:async()=>[metric]},leagues:{leagueById:async()=>league}}});assert.deepEqual(loaded,input,"repository-backed load attaches by UUID");
