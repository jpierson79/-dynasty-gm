...
assert.match(main,/authService\.js\?v5-4-6e-gate4c-auth/,"exact module graph must select the repaired auth implementation");
assert.match(html,/main\.js\?v5-4-6e-gate4c-auth/,"cache-busted entry point must load the repaired event binding");
