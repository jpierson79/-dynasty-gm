...
assert.match(main,/playerSearchButton/,"text search should run from the explicit Apply action");
assert.match(main,/event\.key==="Enter"/,"Enter should execute player search");
assert.doesNotMatch(main,/#playerSearch"\)\?\.addEventListener\("input",debounce/,"typing should not query the cloud");
